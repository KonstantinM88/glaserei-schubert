      ...
      <div className="relative z-10 container-site text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4">
          <a href={`/${locale}/kontakt`}
            className="w-full sm:w-auto inline-flex h-12 md:h-14 items-center justify-center gap-2 px-6 md:px-8 bg-white text-steel text-sm font-semibold rounded-sm hover:bg-neutral-100 transition-all duration-300 shadow-lg hover:shadow-xl hover:-translate-y-0.5">
            {primaryLabel}
          ...
          <a href="tel:+493412412262"
            className="w-full sm:w-auto inline-flex h-12 md:h-14 items-center justify-center gap-2.5 px-6 md:px-8 bg-white/15 border border-white/30 text-white text-sm font-medium rounded-sm hover:bg-white/25 transition-all duration-300">
